...
sealed class SnackBar(open val text: String = "", open val duration: Long = 0) {
    ...
    sealed class Show : SnackBar() {
        ...
        data class WheelChairTransfer(override val text: String, override val duration: Long) :
            Show()
        ...
        data class ChangeDropoffPoint(override val text: String, override val duration: Long) :
            Show()
    }
}
